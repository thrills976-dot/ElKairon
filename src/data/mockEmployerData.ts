...
export const PRE_VETTED_CANDIDATES: PreVettedCandidate[] = [
  ...
  // Hospitality & Culinary Sector
  {
    ...
    fastTrackEligible: true,
    availability: 'Immediate',
    avatar: 'https://ui-avatars.com/api/?name=User+7&background=0D9488&color=fff&size=128',
  ...
  },
  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=User+8&background=0D9488&color=fff&size=128',
  ...
  // Tech & Engineering Sector
  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=User+9&background=0D9488&color=fff&size=128',
...
export const INITIAL_EMPLOYER_MESSAGES: EmployerMessage[] = [
  {
    ...
    candidateId: 'cand-hc-1',
    candidateName: 'Dr. Amina Benali',
    candidateAvatar: 'https://ui-avatars.com/api/?name=User+10&background=0D9488&color=fff&size=128',
  ...
  },
  {
    ...
    candidateId: 'cand-cs-1',
    candidateName: 'Marko Petrovic',
    candidateAvatar: 'https://ui-avatars.com/api/?name=User+11&background=0D9488&color=fff&size=128',
  ...
  },
  {
    ...
    candidateAvatar: 'https://ui-avatars.com/api/?name=User+12&background=0D9488&color=fff&size=128',
