...
export function GuaranteedBenefits() {
  return (
    <section id="benefits" className="py-24 bg-gradient-to-b from-navy-950 via-[#041a2e] to-navy-950 text-white relative overflow-hidden border-t border-b border-white/10">
          ...
          {benefits.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="bg-navy-900/90 rounded-2xl p-6 border border-white/10 hover:border-gold-400/60 transition-all duration-300 shadow-xl flex flex-col justify-between group relative overflow-hidden"
              >
                {/* Subtle top accent bar on hover */}
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-teal-400 to-gold-400 opacity-0 group-hover:opacity-100 transition-opacity" />
