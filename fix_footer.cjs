...
const oldFooterStart = '<footer id="contact"';
const oldFooterEnd = '</footer>';

const startIndex = code.indexOf(oldFooterStart);
const endIndex = code.indexOf(oldFooterEnd) + oldFooterEnd.length;

if (startIndex !== -1 && endIndex !== -1) {
  const newFooter = `<footer id="contact" className="bg-[#044c77] border-t border-white/10 mt-auto z-10 relative text-white">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center gap-3 text-gray-300 text-sm">
                  ...
                  <a href="tel:+27878280628" className="hover:text-gold-400 transition-colors">+27 87 828 0628</a>
                </li>
              </ul>
            </div>
